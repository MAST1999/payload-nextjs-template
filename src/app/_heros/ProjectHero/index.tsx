...
import { Category, Project, Media as MediaType } from "../../../payload/payload-types";
...
export const ProjectHero: React.FC<{
  ...
  const { id, title, categories, meta: { image, description } = {}, createdAt } = project;
  const metaImage = image as MediaType;
