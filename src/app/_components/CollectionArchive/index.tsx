...
import { Category, Post, Project } from "../../../payload/payload-types";
...
export const CollectionArchive: React.FC<Props> = (props) => {
  ...
  const [results, setResults] = useState<Result>({
    totalDocs: isNumber(populatedDocsTotal) ? populatedDocsTotal : 0,
    docs:
      populatedDocs?.map((doc) => doc.value as Project | Post) ||
      selectedDocs?.map((doc) => doc.value as Project | Post) ||
      [],
    page: 1,
    totalPages: 1,
    hasPrevPage: false,
